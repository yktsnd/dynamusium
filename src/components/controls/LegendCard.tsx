...
/**
 * "How to read" overlay explaining the visual encoding used across the
 * network view and charts. Purely explanatory — dismissing it only hides the
 * overlay. Closed by default; opened via the rail's `legend-toggle` button.
 */
export function LegendCard() {
  ...
  return (
    <div className="legend-scrim" onClick={() => setLegendOpen(false)}>
      <div
